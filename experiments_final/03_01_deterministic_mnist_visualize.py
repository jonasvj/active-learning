    ...
    for file in files:
        ...
        dfs.append(
            pd.DataFrame({
                ...
                'model_ce_test': tracker.get_stat('model_ce_test'),
                'model_avg_conf_test': tracker.get_stat('model_avg_conf_test'), 
            })
        )
