...
for seed in "${seeds[@]}"; do
    for acquisition_function in "${acquisition_functions[@]}"; do
        ...
        python_command="python3 ${project_dir}/src/models/active_learning.py \
            ...
            inference.fit_hparams.fit_model_hparams.min_epochs=10 \
            inference.fit_hparams.fit_laplace_hparams.likelihood=classification \
            inference.fit_hparams.fit_laplace_hparams.subset_of_weights=last_layer \
