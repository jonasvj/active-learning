...
def main():
    folder = os.path.join(
        project_dir, 'experiments/01_01_mnist_al_curve')
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments/01_01_al_accuracy.pdf'))
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments/01_01_al_ECE.pdf'))
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments/01_01_al_pool_entropy.pdf'))
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments/01_01_al_active_entropy.pdf'))
    ...
    plt.show()
    fig.savefig(
        os.path.join(project_dir, 'experiments/01_01_al_batch_entropy.pdf'))
