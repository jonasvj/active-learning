...
def main():
    ...
    folder = os.path.join(
        project_dir, 'experiments_old/experiments/01_02_mnist_al_curve')
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments_old/experiments/01_02_al_accuracy.pdf'))
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments_old/experiments/01_02_al_ECE.pdf'))
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments_old/experiments/01_02_al_pool_entropy.pdf'))
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments_old/experiments/01_02_al_active_entropy.pdf'))
    ...
    plt.show()
    fig.savefig(
        os.path.join(project_dir, 'experiments_old/experiments/01_02_al_batch_entropy.pdf'))
    ...
    data = MNISTDataset(seed=seed, n_val=n_val)
    ...
    np.save(
        os.path.join(project_dir, f'experiments_old/experiments/mnist_tsne_{n_val}_{seed}.npy'),
        X_train
    )
    t_end = time.time()
    ...
    fig.savefig(
        os.path.join(
            project_dir,
            f'experiments_old/experiments/01_02_mnist_tsne_{n_val}_{seed}_{acquisition_function}.pdf'
        )
    )
