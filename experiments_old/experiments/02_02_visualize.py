...
def main():
    folder = os.path.join(
        project_dir, 'experiments/02_02_mnist_al_curve_subsample_pool')
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[0.5, 1],
        ylabel='Accuracy',
        title='MNIST - Accuracy (subsampled pool)'
    )
    fig.savefig(
        os.path.join(project_dir, 'experiments/02_02_al_accuracy.pdf'))
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[0, 0.2],
        ylabel='ECE',
        title='MNIST - Expected Calibration Error (subsampled pool)',
        legend_loc='upper right'
    )
    fig.savefig(
        os.path.join(project_dir, 'experiments/02_02_al_ECE.pdf'))
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[2, 2.4],
        ylabel='Entropy',
        title='MNIST - Pool Entropy (subsampled pool)',
        legend_loc='lower right'
    )
    fig.savefig(
        os.path.join(project_dir, 'experiments/02_02_al_pool_entropy.pdf'))
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[2, 2.4],
        ylabel='Entropy',
        title='MNIST - Active Entropy (subsampled pool)',
        legend_loc='lower right'
    )
    fig.savefig(
        os.path.join(project_dir, 'experiments/02_02_al_active_entropy.pdf'))
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[0.2, 2.4],
        ylabel='Entropy',
        title='MNIST - Batch Entropy (subsampled pool)',
        legend_loc='lower right'
    )
    plt.show()
    fig.savefig(
        os.path.join(project_dir, 'experiments/02_02_al_batch_entropy.pdf'))
