...
def main():
    folder = os.path.join(
        project_dir, 'experiments/04_00_fmnist_al_curve_subsample_pool')
    ...
    ax.set_title('Fashion MNIST (subsampled pool)')
    ...
    fig.savefig(os.path.join(project_dir, 'experiments/04_00_al_curve.pdf'))
