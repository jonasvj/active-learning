...
inference_params="\
    ...
    inference.init_hparams.n_posterior_samples=65000 \
    inference.init_hparams.subset_of_weights=all \
    inference.fit_hparams.fit_hmc_hparams.warmup_steps=10000 \
    inference.fit_hparams.fit_hmc_hparams.num_chains=1 \
    inference.fit_hparams.fit_hmc_hparams.max_tree_depth=10"
