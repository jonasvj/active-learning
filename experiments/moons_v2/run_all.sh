...
command_list=()
bsub_args_list=()
#methods=("hmc" "hmc_ll" "mcdo" "mfvi" "frvi" "mfvi_ll" "frvi_ll" "laplace" "ensemble" "laplace_ensemble" "laplace_nf" "swag" "swag_svi")
methods=("hmc_ll" "mcdo" "mfvi" "frvi" "mfvi_ll" "frvi_ll" "laplace" "ensemble" "laplace_ensemble" "laplace_nf" "swag" "swag_svi")
