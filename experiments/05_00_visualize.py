...
def main():
    folder = os.path.join(
        project_dir, 'experiments/05_00_swag_al_curve_mnist')
    ...
    fig.savefig(
        os.path.join(project_dir, 'experiments/05_00_al_accuracy.pdf'))
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[0, 0.2],
        ylabel='ECE',
        title='MNIST - Expected Calibration Error',
        legend_loc='upper right'
    )
    fig.savefig(
        os.path.join(project_dir, 'experiments/05_00_al_ECE.pdf'))
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[2, 2.4],
        ylabel='Entropy',
        title='MNIST - Pool Entropy',
        legend_loc='lower right'
    )
    fig.savefig(
        os.path.join(project_dir, 'experiments/05_00_al_pool_entropy.pdf'))
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[2, 2.4],
        ylabel='Entropy',
        title='MNIST - Active Entropy',
        legend_loc='lower right'
    )
    fig.savefig(
        os.path.join(project_dir, 'experiments/05_00_al_active_entropy.pdf'))
    ...
    fig, ax = plot_al_curve(
        ...
        ylim=[0.2, 2.4],
        ylabel='Entropy',
        title='MNIST - Batch Entropy',
        legend_loc='lower right'
    )
    plt.show()
    fig.savefig(
        os.path.join(project_dir, 'experiments/05_00_al_batch_entropy.pdf'))
