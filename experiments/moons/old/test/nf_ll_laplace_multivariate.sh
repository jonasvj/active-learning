...
inference_params="\
    ...
    inference.fit_hparams.fit_model_hparams.n_epochs=10000 \
    ...
    inference.fit_hparams.fit_flow_hparams.n_epochs=10000 \
...
# Figure path
fig_path="fig_path=${plot_folder}/${experiment_name}_do"

python_command="python3 ${project_dir}/experiments/moons/moons2.py \
    ${data_params} \
    ${model_params} \
    ${inference_params} \
    ${fig_path}"
