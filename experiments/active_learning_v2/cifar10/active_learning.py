...
# Turn of tqdm to avoid too large log files
    ...
    for wd in weight_decays:
        ...
        try:
            ...
            fit_stats = model.fit(
                ...
                map_dataloader=active_augmented_dataloader,
...
def select_dropout_rate(
    ...
    print('selected dropout rate:', dropout_rate)
...
def main(cfg):
    ...
    for i in pbar:
        ...
        active_augmented_dataloader = data_augmented.get_dataloader(
            al_dataset.active_indices,
            batch_size=batch_size,
            shuffle=True,
            drop_last=True
        )
