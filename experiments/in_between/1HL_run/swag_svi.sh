...
model_params="\
    ...
    model.model_hparams.hidden_sizes=[50] \
    model.model_hparams.drop_probs=[0.05] \
    model.model_hparams.noise_scale=0.1 \
    model.model_hparams.prior_scale_bias=1.0 \
    model.model_hparams.prior_scale_weight=4.0 \
    model.model_hparams.scale_weight_prior_by_dim=True \
    model.model_hparams.device=cuda"

# Inference parameters
inference_params="\
    inference=swag_svi \
    inference.inference_class=SWAGSVI \
    inference.init_hparams.K=1000 \
    ...
    inference.fit_hparams.fit_swag_hparams.swag_batch_size=10 \
    inference.fit_hparams.fit_swag_hparams.swag_epochs=1000 \
    ...
    inference.fit_hparams.fit_swag_hparams.val_criterion=lpd \
    
    inference.fit_hparams.fit_covar_hparams.svi_lr=1e-2 \
    inference.fit_hparams.fit_covar_hparams.svi_epochs=1000 \
    inference.fit_hparams.fit_covar_hparams.mini_batch=False \
    inference.fit_hparams.fit_covar_hparams.n_variational_samples=32 \
