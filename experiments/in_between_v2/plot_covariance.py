...
def plot_covariance(covariance_matrix, figpath):
    ...
    ax.set_aspect('equal')
    ax.set_xlabel(r'$\boldsymbol{\theta}_i$', fontsize=8*3)
    ax.set_ylabel(r'$\boldsymbol{\theta}_i$', fontsize=8*3)
    ax.set_title(r'$\textrm{cov}[\boldsymbol{\theta}_i, \boldsymbol{\theta}_i]$', fontsize=8*3, pad=8)
